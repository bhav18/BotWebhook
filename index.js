        ...
        if (event.message && !event.message.is_echo) {
          ...
          if (attachments) {
            ...
            wit.message(text).then(({entities}) => {
              ...
              else if(entities['Risk_Feature_MLC'] != undefined && entities['Risk_Feature_MLC'][0]['confidence'] >0.5)
              {
                text_in_reply = entities['Risk_Feature_MLC'][0]['value'];
              }
              else if(entities['identity_fingerprint'] != undefined && entities['identity_fingerprint'][0]['confidence'] >0.1)
              {
                text_in_reply = entities['identity_fingerprint'][0]['value'];
              }
              else if(entities['visa_direct_feature']!= undefined && entities['visa_direct_feature'][0]['confidence'] >0.1)
              {
